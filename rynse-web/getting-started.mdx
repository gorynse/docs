...
<Note>
  Once your account is created, **you must log in with 90 days** before your profile is frozen. If you have trouble resetting your password, please email `support@gorynse.com `to request a manual password reset.
</Note>
