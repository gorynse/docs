...
<CardGroup cols={2}>
  <Card title="Pages you check (reporting)" icon="chart-mixed">
    Dashboard, Fleet Wash Health, Visits, Incidents, Invoices, Spend Controls. This is what your morning looks like — health, spend, and program adoption at a glance.
  </Card>
  <Card title="Pages where you change things (management)" icon="sliders">
    Facilities, Vehicles, Users, Car Wash Locations, Mobile Wash. Most management actions you can do yourself; vehicle, card, and spend-policy changes go through your CSM.
  </Card>
</CardGroup>

The sidebar groups these by category. Here's what each group contains:
...
<AccordionGroup>
  ...
  <Accordion title="Organization" icon="building">
    ...
    - **Car Wash Locations** — a map of the vendors enrolled in your program.
    - **Spend Controls** — the menu of card-spending rules your CSM configures for your fleet.
  </Accordion>
  <Accordion title="Mobile Wash" icon="spray-can-sparkles">
    - **Schedule** — calendar of upcoming on-site visits and completed work orders.
    - **Work Orders** — list view for requesting and tracking on-site washes.
  </Accordion>
  <Accordion title="Billing & activity" icon="receipt">
    - **Visits** — every wash, fuel stop, and visit across your fleet.
    - **Incidents** — declined card swipes with reasons and recommended next steps.
    - **Invoices** — monthly invoices, balances, and budget tracking.
  </Accordion>
  <Accordion title="Account" icon="user-gear">
    - **Settings** — org preferences and per-user notification settings (including Incident alerts).
  </Accordion>
</AccordionGroup>

<Note>
  Everyone you invite into your org has the same level of access today — there are no per-page permission tiers. Keep your user list tight (see [Users](/rynse-web/users)).
</Note>
