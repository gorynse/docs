...
<Steps>
  ...
  <Step title="Pick your organization or facility">
    The selector at the top of the left sidebar sets what every screen is scoped to.

    - If you belong to more than one organization, use it to switch between them. Start typing in the **Search** box to narrow the list. When your organizations are arranged in groups, searching a group's name surfaces every organization in that group — not just the ones whose own names match the text.
    - If you've been given access to specific **facilities**, a small **Organization / Facility** toggle appears. Switch to **Facility** to pick a facility and scope the whole portal — vehicles, users, reports — to just that location. Switch back to **Organization** for the account-wide view.

    Teammates who only have facility access skip the toggle entirely and land straight in their facility. Rynse Web remembers whichever view you used last.
  </Step>
</Steps>
...
<AccordionGroup>
  ...
  <Accordion title="Organization (group)" icon="building">
    ...
    When you switch to the **Facility** view (see [Sign in](#sign-in) above), this group is labeled **Facility** and narrows to the facility you picked.
  </Accordion>
...
<Note>
  There are no per-page permission tiers. Teammates have either **organization** access (the whole account) or **facility** access (one or more specific facilities) — you set this per person on the [Users](/rynse-web/users) page. Keep your user list tight either way.
...
A few ways to get help from inside the portal:

- **Help link** — the **Help** button in the top navigation bar opens this documentation site in a new tab, so answers are always one click away.
