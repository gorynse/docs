...
<AccordionGroup>
  ...
  <Accordion title="Can I get driver-level attribution (e.g., who washed using this vehicle's card)?">
    No — Rynse attributes every transaction to the vehicle, not the driver. If you need to control timing or limit usage, ask your CSM about schedule and per-transaction caps in [Spend Controls](/rynse-web/spend-controls).
  </Accordion>
