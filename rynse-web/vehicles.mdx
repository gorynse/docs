...
<Info>
  **The Vehicles list is read-only.** Adding, editing, archiving, swapping cards between vehicles, or changing memberships is handled by the Rynse team — see [Asking us to make changes](#asking-us-to-make-changes) below. The actions you *can* take from this page (Freeze Card, Close Card, Change Facility) are covered further down.
</Info>
...
<Steps>
  <Step title="Email support@gorynse.com">
    Send an email to <a href="mailto:support@gorynse.com">support@gorynse.com</a> describing what you need.
  </Step>
