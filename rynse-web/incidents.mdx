...
<AccordionGroup>
  ...
  <Accordion title="Confirm a decline you can't find under Incidents">
    Switch the view toggle to **All Declines**. This shows every declined authorization in the window, including ones that didn't trip a Rynse rule (e.g. PIN entered wrong at the pump, terminal communication errors). If the swipe shows up here but not under Incidents, the network rejected it before our rules even ran.
  </Accordion>
