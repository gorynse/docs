...
**Settings** is where you manage the email notifications Rynse sends to *your* inbox. Open it from the menu at [app.v2.gorynse.com/settings](https://app.v2.gorynse.com/settings).
...
<Warning>
  Saving only affects *your* profile. To roll a preference out across the team, ask each user to log in and enable it themselves. There is no admin-level "enable for everyone" toggle today.
</Warning>
