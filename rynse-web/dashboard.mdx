...
The Dashboard is the first page you see at `app.v2.gorynse.com`. It rolls up activity across every vehicle and card for the period and facility you choose — totals, averages, and where trends are heading.
