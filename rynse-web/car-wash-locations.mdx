...
The **Car Wash Locations** page is the live map of every vendor location available to your organization, with your own facilities pinned in red so you can see vendor coverage at a glance. It's also what powers the QR code on the driver one-pager — drivers scan it, tap any pin on their phone, and get turn-by-turn driving directions to that vendor.
...
<CardGroup cols={2}>
  ...
  <Card title="Your facilities" icon="building" color="#d33">
    Your own sub-locations (depots, yards, precincts) pinned in red so you can see which vendors sit closest to each one.
  </Card>
...
<AccordionGroup>
  ...
  <Accordion title="Proximity analysis" icon="magnifying-glass-location">
    Use the red facility pins to spot coverage gaps. "Is there a vendor near our south station?" becomes a 10-second question — pan to the facility and check the nearby pins. If coverage looks thin in a region, that's a great thing to raise on your next check-in so we can prioritize adding vendors there.
  </Accordion>
</AccordionGroup>
...
- **Missing your own facility?** Add it on the **Organization → Facilities** page — facility pins are driven by the addresses there.
