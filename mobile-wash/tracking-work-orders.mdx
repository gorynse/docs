...
Below that, a **request summary** gathers everything in one place: the work order number, who requested it, your preferred date window, the purchase order (if you entered one), the services, the service address, and — once assigned — the vendor and scheduled date. Completed orders also list the vehicles serviced, the services applied, and the total that rolls up to your invoice.
