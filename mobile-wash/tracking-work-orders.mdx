...
- **Scheduled** (blue) — upcoming visits coordinated with your vendor.
- **Completed** (green) — past work orders that have been processed, with the vehicle count in the label.

Click any day to see its entries in the side panel. Click a completed event to open the work order detail.
...
**Mobile Wash → Work Orders** lists every work order for your organization, at any status. Click any row to open its full detail — every vehicle, the services applied, and (for completed orders) the per-line pricing that rolls up to your invoice.
