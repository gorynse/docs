...
<Note>
  Today, Schedule shows scheduled recurring visits and completed work orders. Manual work orders you've submitted that haven't been picked up yet appear on **Work Orders** but not yet as scheduled events on the calendar.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Seeing which vehicles will be hit on the next visit">
    Today, the Schedule shows when an upcoming recurring visit will happen and at which facility, but the specific vehicle list for that visit is finalized by your vendor at the time of service. The completed work order — once processed — will show the exact vehicles that were washed.
  </Accordion>
</AccordionGroup>
